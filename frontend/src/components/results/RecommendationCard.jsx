...
export default function RecommendationCard({ suggestion, drug }) {
  ...
  return (
    <div className="glass glass-hover p-6 rounded-2xl h-full border-l-2 border-l-purpleTheme-500/30">
      {/* Header */}
      <button
            ...
            <div className="pt-4 mt-4 border-t border-white/5 space-y-4">
              ...
              {drug && (
                <div className="mb-4">
                  ...
                  <div className="text-sm text-purpleTheme-300 font-medium mt-0.5">{drug}</div>
                </div>
              )}
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <svg className="w-4 h-4 text-purpleTheme-400/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
